...
class TokenType extends NormalizedStringType 
{
	...
	{
		$validator = \com\servandserv\happymeal\Bindings::create("com\servandserv\happymeal\XML\Schema\TokenTypeValidator",array( $this, $handler ));
		$validator->validate();
	}
