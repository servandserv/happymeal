...
class NonPositiveIntegerType extends IntegerType 
{
	...
	{
		$validator = \com\servandserv\happymeal\Bindings::create("com\servandserv\happymeal\XML\Schema\NonPositiveIntegerTypeValidator",array( $this, $handler ));
		$validator->validate();
	}
