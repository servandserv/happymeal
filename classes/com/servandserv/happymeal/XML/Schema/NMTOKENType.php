...
class NMTOKENType extends TokenType 
{
	...
	{
		$validator = \com\servandserv\happymeal\Bindings::create("com\servandserv\happymeal\XML\Schema\NMTOKENTypeValidator",array( $this, $handler ));
		$validator->validate();
	}
