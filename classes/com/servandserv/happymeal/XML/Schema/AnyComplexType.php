	            ...
	            if( method_exists( $this, $prop["getter"] ) ) {
	                ...
	                foreach( $vals as $val ) {
	                    if( $prop["xmlns"] == $xmlns ) {
	                        ...
	                        if($prop["class"]) {
	                            $val->toXmlWriter( $xw, $prop["nodeName"], $prop["xmlns"], \com\servandserv\happymeal\XMLAdaptor::CONTENTS );
	                        } else {
	                            $xw->text( $val );
	                        }
	                        $xw->endElement();
	                        ...
	                        if($prop["class"]) {
	                            $val->toXmlWriter( $xw, $prop["nodeName"], $prop["xmlns"], \com\servandserv\happymeal\XMLAdaptor::ELEMENT );
	                        } else {
