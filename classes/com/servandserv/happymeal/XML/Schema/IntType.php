...
class IntType extends LongType 
{
	...
	{
		$validator = \com\servandserv\happymeal\Bindings::create("com\servandserv\happymeal\XML\Schema\IntTypeValidator",array( $this, $handler ));
		$validator->validate();
	}
