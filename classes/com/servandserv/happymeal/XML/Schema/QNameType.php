...
class QNameType extends AnySimpleType 
{
	...
	{
		$validator = \com\servandserv\happymeal\Bindings::create("com\servandserv\happymeal\XML\Schema\QNameTypeValidator",array( $this, $handler ));
		$validator->validate();
	}
