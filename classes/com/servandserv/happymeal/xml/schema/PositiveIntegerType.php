...
class PositiveIntegerType extends NonNegativeIntegerType 
{
	
	const ROOT = "positiveInteger";
	const NS = "http://www.w3.org/2001/XMLSchema";
	const PREF = NULL;
	
	public function validateType ( \com\servandserv\happymeal\ErrorsHandler $handler ) 
	{
		$validator = \com\servandserv\happymeal\Bindings::create("com\servandserv\happymeal\xml\schema\PositiveIntegerTypeValidator",array( $this, $handler ));
		$validator->validate();
	}
