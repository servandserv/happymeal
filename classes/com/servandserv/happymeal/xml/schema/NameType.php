...
class NameType extends TokenType 
{
	...
	{
		$validator = \com\servandserv\happymeal\Bindings::create("com\servandserv\happymeal\xml\schema\NameTypeValidator",array( $this, $handler ));
		$validator->validate();
	}
