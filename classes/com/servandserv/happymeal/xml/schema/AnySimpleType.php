...
class AnySimpleType extends AnyType {
    ...
    const PREF = NULL;
    const ANY_SIMPLE_TYPE_VALIDATOR = 'com\servandserv\happymeal\xml\schema\AnySimpleTypeValidator';
    ...
    public function validateType(ErrorsHandler $handler) {
        Bindings::create(self::ANY_SIMPLE_TYPE_VALIDATOR, [$this, $handler])
            ->validate();
    }
