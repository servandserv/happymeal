...
class NonNegativeIntegerType extends IntegerType {
    ...
    public function validateType ( \com\servandserv\happymeal\ErrorsHandler $handler ) {
        $validator = \com\servandserv\happymeal\Bindings::create("com\servandserv\happymeal\xml\schema\NonNegativeIntegerTypeValidator",array( $this, $handler ));
        $validator->validate();
    }
